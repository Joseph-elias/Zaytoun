...
def _post_json(url: str, payload: dict, headers: dict[str, str], timeout: float = 90.0) -> tuple[int, dict]:
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Live smoke test for Agro-copilot LLM chat response.")
    ...
    parser.add_argument(
        "--message",
        default="My olive leaves have dark circular spots with yellow halo. What should I do first?",
